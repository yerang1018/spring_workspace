...
public class Ex03Controller {
	...
	//	GET, POST 메서드를 구분하고싶다면 <view-controller> 태그를 쓸 수 없다
	...
	public String delete(@PathVariable("idx") int idx, RedirectAttributes rttr) {	//	RedirectAttributes rttr	: 리다이렉트하면서 어트리뷰트 보냄
		int row = service.delete(idx);
		
		rttr.addFlashAttribute("msg", row != 0 ? "삭제 성공" : "삭제 실패");	//	alert.jsp 를 안쓰고 리다이렉트하면서 addFlashAttribute
//		addFlashAttribute : 주소 창에 표기되지 않으므로 addAttribute() 보다 폐쇄적이다.
